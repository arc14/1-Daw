...
public class FechaNac {
	...
	private void initialize() {
		...
		JLabel lblTuFechaDe = new JLabel("Tu edad es:");
		...
		btnEnviar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String fechaSinParchear = (String) boxDia.getSelectedItem() + "/" + String.valueOf((boxMes.getSelectedIndex() + 1))
						+ "/" + (String) boxAno.getSelectedItem();
				
				LocalDate fecha = LocalDate.parse(fechaSinParchear,DateTimeFormatter.ofPattern("d/M/yyyy"));
				res.setText(""+ChronoUnit.YEARS.between(fecha,LocalDate.now()));
